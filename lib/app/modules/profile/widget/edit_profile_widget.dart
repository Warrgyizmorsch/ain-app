...
class EditProfileWidget extends GetView<ProfileController> {
  ...
  Widget build(BuildContext context) {
    ...
    // 1. Root me Obx lagaya hai taaki poora page Theme change par rebuild ho
    return Obx(() => Scaffold(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: controller.selectedProfilePhoto.value != null
                              ? DecorationImage(
                            image: FileImage(controller.selectedProfilePhoto.value!),
                            fit: BoxFit.cover,
                          )
                              : null,
                        ),
                        child: controller.selectedProfilePhoto.value == null
                            ? Icon(Icons.person, size: 40, color: AppColors.lightTextHint)
                            : null,
                      ),
                      Positioned(
                        bottom: 0,
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              shape: BoxShape.circle,
                              border: Border.all(color: Colors.white, width: 2), // Keeps white border for contrast
                            ),
            ...
            _buildFieldRow(
              ...
              child: _buildTextField(
                ...
                suffixIcon: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Icon(Icons.calendar_month_outlined, color: AppColors.textSecondary, size: 18),
                    const SizedBox(width: 8),
                ...
                Stack(
                  children: [
                    Container(
                      ...
                      child: controller.selectedProfilePhoto.value == null
                          ? Icon(Icons.person, size: 36, color: AppColors.lightTextHint)
                          : null,
                    ),
                    Positioned(
                      bottom: 0,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      OutlinedButton.icon(
                        ...
                        icon: Icon(Icons.upload_outlined, size: 16, color: AppColors.primary),
                        label: Text(
                          'Change Photo',
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: AppColors.primary.withValues(alpha: 0.1), // Dynamic light background
  ...
  Widget _buildTextField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        filled: true, // Always true so we can color it dynamically
        fillColor: isReadOnly ? AppColors.appBackground : AppColors.white,
        contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
        suffixIcon: suffixIcon,
        suffixIconConstraints: const BoxConstraints(minWidth: 40, minHeight: 40),
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(10),
          borderSide: BorderSide(color: isReadOnly ? Colors.transparent : AppColors.lightDivider),
        ),
  ...
  Widget _buildThemeDropdown() {
    ...
    final currentThemeText = isDark ? 'Dark Mode' : 'Light Mode';

    return PopupMenuButton<String>(
      initialValue: currentThemeText,
      offset: const Offset(0, 40),
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
      color: AppColors.white,
      onSelected: (String newValue) {
        // Dropdown selection properly triggers specific theme
        if (newValue == 'Dark Mode') {
          ThemeService.to.setThemeMode(true);
        } else {
          ThemeService.to.setThemeMode(false);
        }
      },
